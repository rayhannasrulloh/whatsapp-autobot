...
//
const BotName = 'BOT ./Not Weeaboo'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/rayhanyuuichirou/'; // Nama Instagramlu cok
const whatsapplu = '0822-7898-9976'; // Nomor whatsapplu cok
const kapanbotaktif = '12 Jam'; // Kapan bot lu aktif
